#pragma checksum "C:\Users\thomsonsj\apps\ge_app\Views\GroundWater\MONDResults.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a2f92266ed690843e19f84468c5c1f9e2b133703"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a2f92266ed690843e19f84468c5c1f9e2b133703", @"/Views/GroundWater/MONDResults.cshtml")]
...
#line hidden
            ...
            EndContext();
            BeginContext(169, 3791, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "244f3041354944aa9188c56f1f51767a", async() => {
...
");
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f499c13433ff442e8b8496549b43b63e", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4ce7333011d741c39674f0ce4a7bf5f7", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "be7ad5ab718f41f9b700dd3f67909b2d", async() => {
    ...
    ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9cb87012ea294411990a9ffbce1da883", async() => {
            }
            );
...
");
    ...
    function next_page() {
        var ");
            WriteLiteral(@"page = get_value(""qryPage"");
        set_value(""qryPage"", parseInt(page) + 1);
        get_mond_results();
    }
    function get_mond_results() {
        ...
        if (from_dt && to_dt) {
            var url = gint_host + '/mond/project/' + projectid + '/point/' + pointid + '/type/' + mond_type + '?from=' + from_dt.format(dateformat) +'&to=' + to_dt.format(dateformat);
        } else {
            if (page && size) {
                var url = gint_host + '/mond/project/' + projectid + '/point/' + pointid + '/type/' + mond_type + '/?size=' + size + '&page=' + page
            } else {
                var url = gint_host + '/mond/project/' + pr");
            WriteLiteral(@"ojectid + '/point/' + pointid + '/type/' + mond_type;
            }
        }
...
");
        ...
        if (json_data.length>0){ 
            set_innerHTML (""response"",  'Count = ' + json_data.length  + '; Type = ' + json_data[0].MOND_TYPE + '; returned: ' + currentDT)
            renderChart (json_data, 0);
        } else {
            set_innerHTML (""response"",'No records returned: ' + currentDT)
        }
    }
    </script>
");
